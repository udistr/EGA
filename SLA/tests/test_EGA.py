...
ax0.set_xlabel('time')
ax0.plot(t,w[:,0], 'r', label='E1')
ax0.plot(t,w[:,1], 'g', label='E2')
ax0.plot(t,w[:,2], 'b', label='E3')
ax0.legend(loc="lower right") 

ax1.set_ylabel('Forecast and observations')
ax1.set_xlabel('time')
ax1.plot(t[0:-1], X[:,0], 'r', label='E1')
ax1.plot(t[0:-1], X[:,1], 'g', label='E2')
ax1.plot(t[0:-1], X[:,2], 'b', label='E3')
